...
if(isset($_POST["username"])&&isset($_POST["email"])){
    if((new Taikhoan)->kiemTra($_POST["username"], $_POST["email"])!=false){
        ...
        header("location:nhapmxn.php");
    }else{
        $_SESSION["error_message"] = "Tên đăng nhập hoặc email không dùng đăng ký tài khoản";
    }
}
            ...
            <div class="mx-auto p-3" style="width:600px; border: 1px solid rgb(223, 220, 220); border-radius: 10px;">
                <form action="" method="post">
                    <div class="mb-3 mt-3">
                      ...
                      <input type="text" class="form-control" id="" placeholder="Tên đăng nhập" name="username" required>
                    </div>
                    <div class="mb-3">
