            ...
            <div class="mx-auto p-3" style="width:600px; border: 1px solid rgb(223, 220, 220); border-radius: 10px;">
                <form action="" method="post">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="sdt" placeholder="" name="sdt" required>
                    </div> -->
                    <div class="mb-3">
                      <label for="diachi" class="form-label">Địa chỉ</label>
                      <input type="text" class="form-control" id="diachi" placeholder="" name="diachi" required>
                    </div>
                    <button type="submit" class="btn btn-danger d-inline-block mx-auto">OK</button>
                    <button class="btn btn-primary d-inline-block"><a class=" text-white text-decoration-none" href=
