...
$dc = new Diachi();
$data  = $dc->layTatCaByDC($id);
if(isset($_POST["diachi"])){
    $dc->capnhatdiachi($_POST["diachi"], $id);
            ...
            <div class="mx-auto p-3" style="width:600px; border: 1px solid rgb(223, 220, 220); border-radius: 10px;">
                <form action="" method="post">
                    ...
                    <!-- <div class="mb-3 mt-3">
                      ...
                      <br><label for="ten" class="form-label">Tên người nhận</label>
                      <input type="text" class="form-control" id="ten" placeholder="" name="ten" value=
                      <?php
                                echo "'".$data[0]["ten"]."'";
                        ?>
                      required>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="sdt" placeholder="" name="sdt" value=
                      <?php
                                echo "'".$data[0]["sdt"]."'";
                        ?>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="diachi" placeholder="" name="diachi" value=
                      <?php
                                echo "'".$data[0]["chitietdiachi"]."'";
                        ?>
                      
                      required>
                    </div>
                    <button type="submit" class="btn btn-danger d-inline-block mx-auto">OK</button>
                    <button class="btn btn-primary d-inline-block mx-auto"><a class=" text-white text-decoration-none" href=
                    "taikhoan.php?cn=diachi">Trở về</a></button>
                  </form>
            </div>
        </div>
