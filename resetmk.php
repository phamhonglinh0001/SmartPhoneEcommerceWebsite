...
session_start();
if(isset($_POST["pass"])&&isset($_POST["r_pass"])){
    if($_POST["pass"]!=$_POST["r_pass"]){
        $_SESSION["error_message"] = "Nhập lại mật khẩu không chính xác";
    }else{
        (new Taikhoan)->resetMk($_SESSION["username"], $_SESSION["email"], $_POST["pass"]);
        $_SESSION['error_message'] = "Tạo lại mật khẩu thành công. Hãy đăng nhập vào hệ thống";
            ...
            <div class="mx-auto p-3" style="width:600px; border: 1px solid rgb(223, 220, 220); border-radius: 10px;">
                <form action="" method="post">
                    <div class="mb-3 mt-3">
                      ...
                      <input type="password" class="form-control" id="" placeholder="Mật khẩu mới" name="pass" required>
                    </div>
                    <div class="mb-3">
                      <input type="password" class="form-control" id="" placeholder="Nhập lại mật khẩu mới" name="r_pass" required>
                    </div>
