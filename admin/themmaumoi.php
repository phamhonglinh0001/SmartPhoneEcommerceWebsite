...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if(!(new Mausac)->kiemTraTrungTen($ten)){
        (new Mausac)->add($ten);
        $_SESSION["err"] = "Thêm thành công";
    }else{
        $_SESSION["err"] = "Màu đã tồn tại";
    }
                ...
                <form action="" method="post">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered ">
                            ...
                            <tr>
                                <td>
                                    <input type="text" name="mau" class="form-control" required placeholder="Nhập tên màu">
                                </td>
                            </tr>
                            <tr class="text-center">
                                <td>
                                    ...
                                    <a href="suasoluong.php?id=<?php echo $id_ddt; ?>" class="btn btn-primary">Trở về</a>
                                </td>
                            </tr>
                        </table>
                    </div>
