...
<body>
    <div class="root">
        ...
        <div class="" style="min-height: 80vh;">
            <div class="mx-auto" style="padding: 20px;width:600px;">
                <script>
                    function getDataTH(value) {
                        var xmlhttp = new XMLHttpRequest();
                        xmlhttp.onreadystatechange = function() {
                            if (this.readyState == 4 && this.status == 200) {
                                document.getElementById("ddt").innerHTML = (this.responseText);
                            }
                        };
                        xmlhttp.open("GET", "ajaxLayDDTByTH.php?id_th=" + value, true);
                        xmlhttp.send();
                    }

                    function getDataDDT(value) {
                        if (value != null) {
                            var xmlhttp = new XMLHttpRequest();
                            xmlhttp.onreadystatechange = function() {
                                if (this.readyState == 4 && this.status == 200) {
                            ...
                            xmlhttp.open("GET", "ajaxThongso.php?id_ddt=" + value, true);
                            xmlhttp.send();
                        }
                    }
                </script>
                ...
                <br>
                <select onchange="getDataDDT(this.value)" class="form-select" name="ddt" id="ddt">

                </select>
                <div style="margin-top: 10px;padding: 5px;" id="hienthi">
