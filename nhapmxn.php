...
session_start();
if(isset($_POST["mxn"])){
    if($_POST["mxn"]==$_SESSION["r_pass"]){
        header("location:resetmk.php");
    }else{
        $_SESSION["error_message"] = "Mã xác nhận không chính xác";
    }
}
            ...
            <div class="mx-auto p-3" style="width:600px; border: 1px solid rgb(223, 220, 220); border-radius: 10px;">
                <form action="" method="post">
                    <div class="mb-3 mt-3">
                      ...
                      <input type="text" class="form-control" id="" placeholder="Mã xác nhận" name="mxn" required>
                    </div>
